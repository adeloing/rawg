  ...
  const PageDetail = (argument) => {
    const preparePage = () => {
      ...
      const fetchSimilar = (url) => {
        let similarGames = "";
        fetch(`${url}?key=e83d28cc51db413a8d65854f62efb441`)
      ...
      const fetchGame = (url, argument) => {
        ...
        fetch(`${url}/${argument}?key=e83d28cc51db413a8d65854f62efb441`)
          .then((response) => response.json())
          .then((response) => {
            ...
            fetchSimilar(`https://api.rawg.io/api/games/${slug}/game-series`);
          });
      };
