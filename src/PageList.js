...
//import {getHomeDefault, searchGame, platformsIcons, seePlatform} from "./tools";
...
const PageList = (argument = '') => {
  ...
  const prepareFilter = () => {
      ...
      fetch(`https://api.rawg.io/api/platforms?key=e83d28cc51db413a8d65854f62efb441`)
  ...
  const preparePage = () => {
      ...
      const fetchList = async (url, argument) => {
        ...
        if (argument) {
          url = "https://api.rawg.io/api/games?key=e83d28cc51db413a8d65854f62efb441&page_size=30";
      ...
      fetchList(`https://api.rawg.io/api/games?key=e83d28cc51db413a8d65854f62efb441&page_size=30&dates=2023-02-01,2023-05-01&ordering=-metacritic`, cleanedArgument);
  };
